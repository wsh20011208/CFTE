...
```text
/home/jovyan/CFTE
/home/jovyan/CFTE_superposition/CFTE_NoRefine
/home/jovyan/CFTE_superposition/CFTE_Refined_FixedCMR
/home/jovyan/CFTE_superposition/CFTE_Refined_AdaptiveCMR
```

Place this `benchmark_d7` directory under `/home/jovyan/`, then run:

```bash
conda activate cfte39
cd /home/jovyan
bash benchmark_d7/run_four_models_example.sh
```

The runner uses the unique `00000199-checkpoint.pth.tar` found under each
project's `checkpoint_d7` directory. Explicit checkpoint paths can be supplied with:
...
For a short initial check, keep `GAPS=(7)` and run one evaluator
