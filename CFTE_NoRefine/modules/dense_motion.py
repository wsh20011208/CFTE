...
class DenseMotionNetwork(nn.Module):
    ...
    def forward(self, source_image,heatmap_source,heatmap_driving):
        ...
        # Expose the hourglass input component so the two-reference no-refinement
        # baseline can build a post-superposition occlusion branch using the same
        # CFTE motion-aware input structure as the CMR model.
