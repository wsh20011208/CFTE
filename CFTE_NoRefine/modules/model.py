...
class GeneratorFullModel(torch.nn.Module):
    """
    Two-branch CFTE generator model for temporal superposition without motion refinement.
    ...
    The raw past/future deformed representations are superposed at the
    deformation-feature level before one post-superposition occlusion map and
    the final prediction are generated.  No CMR1/CMR2 motion-field refinement is
    ...
    def forward(self, x, lambda_var):
        ...
        # No-refinement path: superpose the raw branch deformed representation,
        # then predict one post-superposition occlusion map and decode the final image.
