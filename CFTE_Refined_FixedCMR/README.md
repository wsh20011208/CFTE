...
> This directory contains the **FixedCMR** two-reference motion-refinement model used in the thesis *Superposition Models Using Multiple Reference Frames for Enhanced Generative Video Quality*.
